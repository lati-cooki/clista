// Generated from ClisTa-Protocol examples/vendor-due-diligence.ndjson — the
// canonical vendor due-diligence decision (NovaPay BaaS partner evaluation),
// companion to the scenario-demo sepsis log. Seeds the vendor-dd thread.
// Do not edit by hand.
export const vendorDueDiligenceEvents = [
  {
    "event_id": "evt_participantadded_par_cro_001",
    "event_type": "ParticipantAdded",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_cro",
  ...
  {
    "event_id": "evt_participantadded_par_mrm_002",
    "event_type": "ParticipantAdded",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:00.035Z",
    "payload": {
      "participant": {
        "id": "par_mrm",
        "object": "participant",
  ...
  {
    "event_id": "evt_participantadded_par_compliance_003",
    "event_type": "ParticipantAdded",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:00.070Z",
    "payload": {
      "participant": {
        "id": "par_compliance",
        "object": "participant",
        "kind": "human",
        "name": "J. Whitfield",
        "role": "bsa_aml officer"
      }
    }
  },
  {
    "event_id": "evt_participantadded_par_fintech_liaison_004",
    "event_type": "ParticipantAdded",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_fintech_liaison",
    "timestamp": "2026-06-28T14:00:00.105Z",
    "payload": {
      "participant": {
        "id": "par_fintech_liaison",
        "object": "participant",
        "kind": "human",
        "name": "S. Pratt",
        "role": "fintech partnership liaison"
      }
    }
  },
  {
    "event_id": "evt_threadcreated_vendor_dd_005",
    "event_type": "ThreadCreated",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_cro",
    "timestamp": "2026-06-28T14:00:00.140Z",
    "payload": {
      "thread": {
        "id": "thd_vendor_dd_baas_partner_eval",
        "object": "thread",
  ...
  {
    "event_id": "evt_evidencecommitted_evd_soc2_type_ii_006",
    "event_type": "EvidenceCommitted",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_fintech_liaison",
    "timestamp": "2026-06-28T14:00:00.175Z",
    "payload": {
      "evidence": {
        "id": "evd_soc2_type_ii",
        "object": "evidence",
        "threadId": "thd_vendor_dd_baas_partner_eval",
        ...
        "confidence": 0.92,
        "committedByParticipantId": "par_fintech_liaison",
        "committedAt": "2026-06-28T14:00:00.175Z",
        "artifactIds": [],
        "contentHash": "sha256:vdd_evd_soc2_type_ii"
      }
    }
  },
  {
    "event_id": "evt_evidencecommitted_evd_bsa_aml_program_007",
    "event_type": "EvidenceCommitted",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:00.210Z",
    "payload": {
      "evidence": {
        ...
        "confidence": 0.88,
        "committedByParticipantId": "par_compliance",
        "committedAt": "2026-06-28T14:00:00.210Z",
        "artifactIds": [],
        "contentHash": "sha256:vdd_evd_bsa_aml_program"
      }
    }
  },
  {
    "event_id": "evt_evidencecommitted_evd_ffiec_exam_history_008",
    "event_type": "EvidenceCommitted",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:00.245Z",
    "payload": {
      "evidence": {
        ...
        "confidence": 0.85,
        "committedByParticipantId": "par_compliance",
        "committedAt": "2026-06-28T14:00:00.245Z",
        "artifactIds": [],
        "contentHash": "sha256:vdd_evd_ffiec_exam_history"
      }
    }
  },
  {
    "event_id": "evt_evidencecommitted_evd_txn_monitoring_assessment_009",
    "event_type": "EvidenceCommitted",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:00.280Z",
    "payload": {
      "evidence": {
        ...
        "confidence": 0.78,
        "committedByParticipantId": "par_mrm",
        "committedAt": "2026-06-28T14:00:00.280Z",
        "artifactIds": [],
        "contentHash": "sha256:vdd_evd_txn_monitoring_assessment"
      }
    }
  },
  {
    "event_id": "evt_evidencecommitted_evd_pen_test_gap_010",
    "event_type": "EvidenceCommitted",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:00.315Z",
    "payload": {
      "evidence": {
        "id": "evd_pen_test_gap",
        "object": "evidence",
        ...
        "confidence": 0.91,
        "committedByParticipantId": "par_mrm",
        "committedAt": "2026-06-28T14:00:00.315Z",
        "artifactIds": [],
        "contentHash": "sha256:vdd_evd_pen_test_gap"
      }
    }
  },
  {
    "event_id": "evt_evidencecommitted_evd_complaint_data_011",
    "event_type": "EvidenceCommitted",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_fintech_liaison",
    "timestamp": "2026-06-28T14:00:00.350Z",
    "payload": {
      "evidence": {
        ...
        "confidence": 0.87,
        "committedByParticipantId": "par_fintech_liaison",
        "committedAt": "2026-06-28T14:00:00.350Z",
        "artifactIds": [],
        "contentHash": "sha256:vdd_evd_complaint_data"
      }
    }
  },
  {
    "event_id": "evt_assumptiondeclared_asm_fraud_model_card_present_only_012",
    "event_type": "AssumptionDeclared",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:00.385Z",
    "payload": {
      "assumption": {
        ...
        "status": "active",
        "evidenceIds": [
          "evd_txn_monitoring_assessment"
        ],
        "confidence": 0.83,
        "declaredByParticipantId": "par_mrm",
        "declaredAt": "2026-06-28T14:00:00.385Z",
        "contentHash": "sha256:vdd_asm_fraud_model_card_present_only"
      }
    }
  },
  {
    "event_id": "evt_assumptiondeclared_asm_bsa_program_occ_compliant_013",
    "event_type": "AssumptionDeclared",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:00.420Z",
    "payload": {
      "assumption": {
        ...
        "evidenceIds": [
          "evd_bsa_aml_program",
          "evd_ffiec_exam_history"
        ],
        "confidence": 0.82,
        "declaredByParticipantId": "par_compliance",
        "declaredAt": "2026-06-28T14:00:00.420Z",
        "contentHash": "sha256:vdd_asm_bsa_program_occ_compliant"
      }
    }
  },
  {
    "event_id": "evt_assumptiondeclared_asm_no_cross_border_wire_demand_014",
    "event_type": "AssumptionDeclared",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_fintech_liaison",
    "timestamp": "2026-06-28T14:00:00.455Z",
    "payload": {
      "assumption": {
        ...
        "confidence": 0.75,
        "declaredByParticipantId": "par_fintech_liaison",
        "declaredAt": "2026-06-28T14:00:00.455Z",
        "contentHash": "sha256:vdd_asm_no_cross_border_wire_demand"
      }
    }
  },
  {
    "event_id": "evt_claimcreated_clm_controls_adequate_ach_domestic_wire_015",
    "event_type": "ClaimCreated",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_fintech_liaison",
    "timestamp": "2026-06-28T14:00:00.490Z",
    "payload": {
      "claim": {
        ...
        "assumptionIds": [
          "asm_bsa_program_occ_compliant"
        ],
        "contradictingEvidenceIds": [],
        "createdByParticipantId": "par_fintech_liaison",
        "createdAt": "2026-06-28T14:00:00.525Z"
      }
    }
  },
  {
    "event_id": "evt_claimcreated_clm_txn_monitoring_gaps_block_full_scope_016",
    "event_type": "ClaimCreated",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:00.560Z",
    "payload": {
      "claim": {
        ...
        "assumptionIds": [],
        "contradictingEvidenceIds": [],
        "createdByParticipantId": "par_mrm",
        "createdAt": "2026-06-28T14:00:00.595Z"
      }
    }
  },
  {
    "event_id": "evt_claimcreated_clm_pen_test_gap_is_material_017",
    "event_type": "ClaimCreated",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:00.630Z",
    "payload": {
      "claim": {
        ...
        "contradictingEvidenceIds": [],
        "createdByParticipantId": "par_mrm",
        "createdAt": "2026-06-28T14:00:00.665Z"
      }
    }
  },
  {
    "event_id": "evt_claimcreated_clm_complaint_profile_acceptable_018",
    "event_type": "ClaimCreated",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:00.700Z",
    "payload": {
      "claim": {
        ...
        "assumptionIds": [],
        "contradictingEvidenceIds": [],
        "createdByParticipantId": "par_compliance",
        "createdAt": "2026-06-28T14:00:00.735Z"
      }
    }
  },
  {
    "event_id": "evt_positiontaken_par_cro_019",
    "event_type": "PositionTaken",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_cro",
    "timestamp": "2026-06-28T14:00:00.770Z",
    "payload": {
      "position": {
        "id": "pos_cro_support",
        "object": "position",
        "threadId": "thd_vendor_dd_baas_partner_eval",
        "participantId": "par_cro",
        "targetObjectId": "clm_controls_adequate_ach_domestic_wire",
        "targetObjectType": "claim",
        "stance": "support",
        "reason": "SOC 2 report and clean exam history support scoped approval for ACH and domestic wire.",
        "takenAt": "2026-06-28T14:00:00.805Z"
      }
    }
  },
  {
    "event_id": "evt_positiontaken_par_mrm_020",
    "event_type": "PositionTaken",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:00.840Z",
    "payload": {
      "position": {
        "id": "pos_mrm_support",
        "object": "position",
        ...
        "targetObjectId": "clm_pen_test_gap_is_material",
        "targetObjectType": "claim",
        "stance": "support",
        "reason": "14-month gap exceeds policy threshold. Remediation timeline must be a condition of approval.",
        "takenAt": "2026-06-28T14:00:00.875Z"
      }
    }
  },
  {
    "event_id": "evt_positiontaken_par_compliance_021",
    "event_type": "PositionTaken",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:00.910Z",
    "payload": {
      "position": {
        "id": "pos_compliance_support",
        "object": "position",
        "threadId": "thd_vendor_dd_baas_partner_eval",
        ...
        "targetObjectType": "claim",
        "stance": "support",
        "reason": "Controls are adequate for scoped deployment, but approval should be conditional on pen-test completion within 60 days.",
        "takenAt": "2026-06-28T14:00:00.945Z"
      }
    }
  },
  {
    "event_id": "evt_objectionraised_pen_test_gap_022",
    "event_type": "ObjectionRaised",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:00.980Z",
    "payload": {
      "objection": {
        ...
        "status": "open",
        "raisedAt": "2026-06-28T14:00:01.015Z"
      }
    }
  },
  {
    "event_id": "evt_objectionraised_scope_creep_023",
    "event_type": "ObjectionRaised",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:01.050Z",
    "payload": {
      "objection": {
        ...
        "status": "open",
        "raisedAt": "2026-06-28T14:00:01.085Z"
      }
    }
  },
  {
    "event_id": "evt_decisionrequestopened_vendor_dd_024",
    "event_type": "DecisionRequestOpened",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_cro",
    "timestamp": "2026-06-28T14:00:01.120Z",
    "payload": {
      "decisionRequest": {
        "id": "drq_vendor_dd_novapay",
        ...
        "supportingClaimIds": [
          "clm_controls_adequate_ach_domestic_wire",
          "clm_txn_monitoring_gaps_block_full_scope",
          "clm_pen_test_gap_is_material",
          "clm_complaint_profile_acceptable"
        ],
        "supportingAssumptionIds": [
          "asm_fraud_model_card_present_only",
          "asm_bsa_program_occ_compliant",
          "asm_no_cross_border_wire_demand"
        ],
        "objectionIds": [
          "obj_pen_test_gap_unresolved",
          "obj_cross_border_wire_scope_creep"
        ],
        "openedByParticipantId": "par_cro",
        "openedAt": "2026-06-28T14:00:01.155Z"
      }
    }
  },
  {
    "event_id": "evt_reviewsubmitted_mrm_review_025",
    "event_type": "ReviewSubmitted",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_mrm",
    "timestamp": "2026-06-28T14:00:01.190Z",
    "payload": {
      "review": {
        "id": "rev_mrm_approve_conditions",
        "object": "review",
        "threadId": "thd_vendor_dd_baas_partner_eval",
        "decisionRequestId": "drq_vendor_dd_novapay",
        ...
        "reviewedAt": "2026-06-28T14:00:01.225Z"
      }
    }
  },
  {
    "event_id": "evt_reviewsubmitted_compliance_review_026",
    "event_type": "ReviewSubmitted",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:01.260Z",
    "payload": {
      "review": {
        ...
        "reviewedAt": "2026-06-28T14:00:01.295Z"
      }
    }
  },
  {
    "event_id": "evt_decisionmerged_vendor_dd_027",
    "event_type": "DecisionMerged",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_cro",
    "timestamp": "2026-06-28T14:00:01.330Z",
    "payload": {
      "decisionRecord": {
        "id": "dcr_vendor_dd_novapay",
        ...
        "reviewIds": [
          "rev_mrm_approve_conditions",
          "rev_compliance_request_changes"
        ],
        "authorityTrail": [
          {
            "participantId": "par_cro",
        ...
        "minorityReportIds": [
          "mnr_compliance_pen_test_dissent"
        ],
        ...
        "decidedAt": "2026-06-28T14:00:01.365Z",
        "contentHash": "sha256:vdd_dcr_vendor_dd_novapay"
      }
    }
  },
  {
    "event_id": "evt_minorityreportfiled_compliance_dissent_028",
    "event_type": "MinorityReportFiled",
    "thread_id": "thd_vendor_dd_baas_partner_eval",
    "actor_id": "par_compliance",
    "timestamp": "2026-06-28T14:00:01.400Z",
    "payload": {
      "minorityReport": {
        "id": "mnr_compliance_pen_test_dissent",
        "object": "minorityReport",
        "threadId": "thd_vendor_dd_baas_partner_eval",
        "decisionRecordId": "dcr_vendor_dd_novapay",
        "participantId": "par_compliance",
        ...
        "filedAt": "2026-06-28T14:00:01.435Z",
